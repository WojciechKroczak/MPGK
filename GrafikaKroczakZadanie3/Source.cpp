...
GLint ProgramMPGK::macierzTShader;
...
void  ProgramMPGK::wyswietl()
{
	...
	Przeksztalcenia prz;
	Macierz Obrot = prz.Obrot3D(45, 'y');
	Macierz Skalowanie = prz.Skalowanie3D(0.5, 0.5, 0.5);
	Macierz Przesuniecie = prz.Przesuniecie3D(0.3, 0.5, 0.2);

	Macierz Transformacja = Skalowanie;

	GLfloat macierzV[4][4];
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			macierzV[i][j] = Transformacja.get(i, j);
		}
	}
	...
	glUniformMatrix4fv(macierzTShader, 1, GL_TRUE, &macierzV[0][0]);
	//glUniform1f(zmiennaObrShader, obrot);
	//{1234} oznacza odpowiednio 1,2,3,4 zmiany
	//glUniformMatrix4fv(macierzShader, 1, GL_FALSE, Transformacja);
...
void ProgramMPGK::stworzenieVBO() //tworzy bufor (na wierzcholki) i wypelnia go danymi
{
	...
	//Macierz Obrot = prz.Obrot3D(45, 'y');
	//Macierz Skalowanie = prz.Skalowanie3D(1, 2, 2);
	//Macierz Przesuniecie = prz.Przesuniecie3D(0.8, 0.2, 0.2);

	//for (int i = 0; i < sizeof(obiekty2) / sizeof(obiekty2[0]); i++) {
	//	obiekty2[i] = Obrot * obiekty2[i];
	//	i++;
	//}

	//for (int i = 0; i < sizeof(obiekty2) / sizeof(obiekty2[0]); i++) {
	//	obiekty2[i] = Skalowanie * obiekty2[i];
	//	i++;
	//}

	//for (int i = 0; i < sizeof(obiekty2)/sizeof(obiekty2[0]); i++) {
	//	obiekty2[i] = Przesuniecie * obiekty2[i];
	//	i++;
	//}
...
void ProgramMPGK::stworzenieProgramu()
{
	...
	macierzTShader = glGetUniformLocation(programZShaderami, "macierzShader");
...
int main(int argc, char** argv)
{
	...
	//cout << "Zadanie 1.1.1" << endl;
	//Macierz macP1 = prz.Skalowanie2D(3.3);
	//cout << macP1 << endl;
	//cout << "Zadanie 1.1.2" << endl;
	//Macierz macP2 = prz.Skalowanie2D(3.3, 5.1);
	//cout << macP2 << endl;
	//cout << "Zadanie 1.1.3" << endl;
	//float tabP[2] = { 1.3,2.1 };
	//Macierz macP3 = prz.Skalowanie2D(tabP);
	//cout << macP3 << endl;

	//cout << "Zadanie 1.2" << endl;
	//Macierz macP112 = prz.Obrot2D(15);
	//cout << macP112 << endl;

	//cout << "Zadanie 1.3.1" << endl;
	//Macierz macP11 = prz.Przesuniecie2D(3.3);
	//cout << macP11 << endl;
	//cout << "Zadanie 1.3.2" << endl;
	//Macierz macP21 = prz.Przesuniecie2D(3.3, 5.1);
	//cout << macP21 << endl;
	//cout << "Zadanie 1.3.3" << endl;
	//float tabP2[2] = { 1.3,2.1 };
	//Macierz macP31 = prz.Przesuniecie2D(tabP2);
	//cout << macP31 << endl;
	...
	//cout << "Zadanie 2.1.1" << endl;
	//Macierz macP4 = prz.Skalowanie3D(3.3);
	//cout << macP4 << endl;
	//cout << "Zadanie 2.1.2" << endl;
	//Macierz macP5 = prz.Skalowanie3D(1.2, 1.3, 1.4);
	//cout << macP5 << endl;
	//cout << "Zadanie 2.1.3" << endl;
	//float tabP1[3] = { 1.4,1.5,1.6 };
	//Macierz macP6 = prz.Skalowanie3D(tabP1);
	//cout << macP6 << endl;

	//cout << "Zadanie 2.3.1" << endl;
	//Macierz macP01 = prz.Przesuniecie3D(0.9);
	//cout << macP01 << endl;
	//cout << "Zadanie 2.3.2" << endl;
	//Macierz macP12 = prz.Przesuniecie3D(1.4, 1.5, 1.6);
	//cout << macP12 << endl;
	//cout << "Zadanie 2.3.3" << endl;
	//float tabP21[3] = { 1.1,1.2,1.3 };
	//Macierz macP13 = prz.Przesuniecie3D(tabP21);
	//cout << macP13 << endl;


	//cout << "Zadanie 2.2" << endl;
	//cout << "Obrot X" << endl;
	//Macierz macP41 = prz.Obrot3D(15, 'x');
	//cout << macP41 << endl;
	//cout << "Obrot Y" << endl;
	//Macierz macP42 = prz.Obrot3D(15, 'y');
	//cout << macP42 << endl;
	//cout << "Obrot Z" << endl;
	//Macierz macP43 = prz.Obrot3D(15, 'z');
	//cout << macP43 << endl;
	////Macierz macP42 = prz.Obrot3D(15, 'y');
	////Macierz macP43 = prz.Obrot3D(15, 'z');
	//cout << "Test" << endl;
	//Przeksztalcenia test = macP41;
	//cout << test << endl;
